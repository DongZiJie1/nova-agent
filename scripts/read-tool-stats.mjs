...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".nova/agent/sessions");
const DEFAULT_ACTIVE_READ_TOOL_PATH = path.join(process.cwd(), "packages/nova/src/core/tools/read.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.nova/agent/sessions)
