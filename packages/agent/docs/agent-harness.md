...
- Verify `before_agent_start` hook semantics against nova.
...
- Map nova resources to sourced loaders.
...
- Move nova stream/auth/retry/header behavior onto harness stream configuration and provider hooks.
