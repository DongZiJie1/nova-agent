 ...
 *
 * Usage: nova --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@dongzijie1/nova";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@dongzijie1/pi-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@dongzijie1/pi-tui";
...
export default function (nova: ExtensionAPI) {
	...
	nova.registerCommand("overlay-animation", {
	...
	nova.registerCommand("overlay-anchors", {
	...
	nova.registerCommand("overlay-margins", {
	...
	nova.registerCommand("overlay-stack", {
	...
	nova.registerCommand("overlay-overflow", {
	...
	nova.registerCommand("overlay-edge", {
	...
	nova.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	nova.registerCommand("overlay-maxheight", {
	...
	nova.registerCommand("overlay-sidepanel", {
	...
	nova.registerCommand("overlay-toggle", {
	...
	nova.registerCommand("overlay-passive", {
	...
	nova.registerCommand("overlay-focus", {
	...
	nova.registerCommand("overlay-streaming", {
	...
	private startProcess(): void {
		...
		this.proc = spawn("bash", [
			...
			for i in $(seq 1 100); do
				...
				DIR="/Users/nicobailon/Documents/development/nova-agent/packages/nova/src/modes/interactive"
				...
				if [ $((i % 5)) -eq 0 ]; then
					echo -e "  \\033[32m✓ Successfully processed \${i} files in /Users/nicobailon/Documents/development/nova-agent\\033[0m"
				fi
				if [ $((i % 7)) -eq 0 ]; then
