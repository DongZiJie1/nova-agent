 ...
 *
 * Usage: nova --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@dongzijie1/pi-tui";

export default function (nova: ExtensionAPI) {
	nova.registerCommand("overlay-test", {
