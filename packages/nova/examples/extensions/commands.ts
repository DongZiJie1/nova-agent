 ...
 * Commands Extension
 *
 * Demonstrates the nova.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@dongzijie1/nova";

export default function commandsExtension(nova: ExtensionAPI) {
	nova.registerCommand("commands", {
