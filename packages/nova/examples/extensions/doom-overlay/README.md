...
Play DOOM as an overlay in nova. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
nova --extension ./examples/extensions/doom-overlay
```
