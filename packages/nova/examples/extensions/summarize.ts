import type { ExtensionAPI, ExtensionCommandContext } from "@dongzijie1/nova";
import { DynamicBorder, getMarkdownTheme } from "@dongzijie1/nova";
...
export default function (nova: ExtensionAPI) {
	nova.registerCommand("summarize", {
