 ...
 *   cd packages/nova/examples/extensions/custom-provider && npm install
 *
 *   # With OAuth (run /login custom-anthropic first)
 *   nova -e ./packages/nova/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... nova -e ./packages/nova/examples/extensions/custom-provider
 *
...
export default function (nova: ExtensionAPI) {
	nova.registerProvider("custom-anthropic", {
