 ...
 * working indicator shown while nova is streaming a response.
 *
 * Usage:
 *   nova --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore nova's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@dongzijie1/nova";
...
export default function (nova: ExtensionAPI) {
	...
	nova.registerCommand("working-indicator", {
