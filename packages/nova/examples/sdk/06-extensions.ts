...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@dongzijie1/nova";
...
export default function (nova: ExtensionAPI) {
	...
	// Register a command
	nova.registerCommand("mycommand", {
