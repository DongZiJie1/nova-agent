...
import type { OAuthCredentials } from "@dongzijie1/pi-ai";
import { getModel, streamSimple } from "@dongzijie1/pi-ai/compat";
import { builtinProviders } from "@dongzijie1/pi-ai/providers/all";
...
// ============================================================================
// OAuth API key resolution from ~/.nova/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".nova", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.nova/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.nova/agent/auth.json
 */
