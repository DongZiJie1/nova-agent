...
- [`packages/nova/src/core/session-manager.ts`](https://github.com/earendil-works/pi-mono/blob/main/packages/nova/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/nova/src/core/messages.ts`](https://github.com/earendil-works/pi-mono/blob/main/packages/nova/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
