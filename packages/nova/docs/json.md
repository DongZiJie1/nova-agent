...
Events are defined in [`AgentSessionEvent`](https://github.com/earendil-works/pi-mono/blob/main/packages/nova/src/core/agent-session.ts#L102):
...
Extended messages from [`packages/nova/src/core/messages.ts`](https://github.com/earendil-works/pi-mono/blob/main/packages/nova/src/core/messages.ts#L29):
