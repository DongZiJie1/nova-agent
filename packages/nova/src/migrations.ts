...
const MIGRATION_GUIDE_URL =
	"https://github.com/earendil-works/pi-mono/blob/main/packages/nova/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/earendil-works/pi-mono/blob/main/packages/nova/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.nova/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.nova/agent/ instead of
 * ~/.nova/agent/sessions/<encoded-cwd>/. This migration moves them
