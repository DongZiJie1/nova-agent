...
import type { ThinkingLevel } from "@dongzijie1/pi-agent-core";
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as NOVA_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  NOVA_PACKAGE_DIR                 - Override package directory (for Nix/Guix store paths)
  NOVA_OFFLINE                     - Disable startup network operations when set to 1/true/yes
  NOVA_TELEMETRY                   - Override install telemetry when set to 1/true/yes or 0/false/no
  NOVA_SHARE_VIEWER_URL            - Base URL for /share command (default: https://pi.dev/session/)
