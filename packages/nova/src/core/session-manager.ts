...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@dongzijie1/pi-ai";
 ...
 * Encodes cwd into a safe directory name under ~/.nova/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.nova/agent/sessions/<encoded-cwd>/).
	 */
