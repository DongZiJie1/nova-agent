...
import { complete, type UserMessage } from "@dongzijie1/pi-ai/compat";
import type { ExtensionAPI } from "@dongzijie1/pi-coding-agent";
import { BorderedLoader } from "@dongzijie1/pi-coding-agent";
