...
import type { AssistantMessage, Model } from "@dongzijie1/pi-ai";
...
vi.mock("@dongzijie1/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@dongzijie1/pi-ai/compat")>();
	return {
		...actual,
