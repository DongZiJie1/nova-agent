...
export class TUI extends Container {
	...
	private showHardwareCursor = getNovaEnv("HARDWARE_CURSOR") === "1";
	private clearOnShrink = getNovaEnv("CLEAR_ON_SHRINK") === "1"; // Clear empty rows when content shrinks (default: off)
	...
	constructor(terminal: Terminal, showHardwareCursor?: boolean, logDirectory?: string) {
		...
		this.logDirectory = logDirectory ?? getNovaEnv("CODING_AGENT_DIR") ?? path.join(os.homedir(), ".nova", "agent");
	...
	private doRender(): void {
		...
		const debugRedraw = getNovaEnv("DEBUG_REDRAW") === "1";
		...
		// Configurable via setClearOnShrink() or NOVA_CLEAR_ON_SHRINK=0 env var
